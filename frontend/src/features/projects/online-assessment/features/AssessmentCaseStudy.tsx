  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      <div className="rounded-3xl bg-[#0e121a] border border-stone-800 p-7 sm:p-10 md:p-12 text-stone-100 shadow-xl shadow-black/40">
        {/* Header Section */}
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-cyan-500/15 border border-cyan-400/35 text-cyan-300 text-xs font-semibold uppercase tracking-wider mb-4 shadow-2xs">
            <AssessmentIcon className="w-4 h-4 text-cyan-400" />
