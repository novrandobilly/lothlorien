...
export function KickserveManualCard() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      {/* Gold Brass Paper Manual Card Container */}
      <div className="rounded-3xl bg-linear-to-b from-[#1b1610] via-[#14100b] to-[#0e0b07] border border-amber-600/30 shadow-2xl shadow-black/90 p-7 sm:p-10 md:p-12 ring-1 ring-amber-500/10">
        {/* 1. Header & Title */}
        <div className="mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-300 text-xs font-semibold uppercase tracking-wider mb-4">
        ...
        <div className="mb-10 p-6 sm:p-8 rounded-2xl bg-[#120e09]/95 border border-amber-500/20 shadow-xs">
          <h2 className="text-xl sm:text-2xl font-serif text-amber-100 mb-6">
            What can you manage?
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
            {kickserveData.whatCanYouManage.map((item, idx) => (
              <div key={idx} className="flex items-start gap-3.5">
                ...
                <div>
                  <h3 className="text-base font-serif font-medium text-amber-100">
                    {item.title}
                  </h3>
                  <p className="text-sm text-stone-300 leading-relaxed mt-1 font-sans">
                    {item.description}
                  </p>
                </div>
              </div>
        ...
        <div className="flex justify-center mb-10">
          ...
          >
            <LothlorienButton
              variant="gold"
              size="lg"
              className="px-8 py-3.5 text-sm sm:text-base font-semibold shadow-lg shadow-amber-950/60 cursor-pointer"
        ...
        {/* 5. Line Divider */}
        <div className="border-t border-amber-600/20 my-10 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4 bg-[#14100b] text-xs font-mono uppercase tracking-widest text-amber-300/80 border border-amber-500/25 rounded-full py-0.5">
            App Gallery
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          <div className="w-full max-w-[290px] sm:max-w-[310px] rounded-[38px] p-3 sm:p-3.5 bg-[#120e0a] border-2 border-amber-600/30 shadow-2xl shadow-black ring-1 ring-white/5">
            {/* Dynamic Island / Speaker Notch */}
            <div className="w-22 h-3.5 bg-stone-950 rounded-full mx-auto mb-2.5" />

            {/* Smartphone Screen Viewport */}
            <div className="w-full rounded-[28px] overflow-hidden bg-[#0a0805] border border-stone-800/90 flex flex-col min-h-[450px] sm:min-h-[480px] justify-between p-4 font-sans text-xs">
              {/* Status Bar */}
              <div className="flex items-center justify-between text-[10px] text-stone-400 px-1 mb-3">
                <span className="font-mono font-medium text-stone-300">9:41</span>
                ...
                {activeTabId === "custom-players" && (
                  <div className="space-y-2 py-1">
                    ...
                    <div className="flex items-center justify-between p-2 rounded-xl bg-stone-900 border border-stone-800 text-[11px]">
                      <span className="text-stone-400 font-sans">+ Add player name...</span>
                    ...
                    <div className="space-y-1.5 max-h-[260px] overflow-hidden">
                      {[
                        ...
                        { name: "Michael T.", seed: "#3 Seed", court: "Court 2" },
                        { name: "Emma R.", seed: "#4 Seed", court: "Court 2" },
                        { name: "David L.", seed: "#5 Seed", court: "Court 3" },
                        { name: "Jessica W.", seed: "#6 Seed", court: "Court 3" },
                      ].map((p, i) => (
                        <div
                          key={i}
                  ...
                  <div className="space-y-2.5 py-1">
                    ...
                    <div className="p-2.5 rounded-xl bg-[#14100b] border border-stone-800 space-y-1.5">
                      <div className="flex items-center justify-between text-[10px] text-stone-400">
                        <span className="font-mono text-amber-300 font-semibold">COURT 1</span>
                        <span className="font-mono text-amber-200 font-bold">21 - 16</span>
                      </div>
                      <div className="flex items-center justify-between text-[11px] text-stone-200">
                        <span className="truncate">Billy N. &amp; Sarah K.</span>
                        <span className="text-stone-500 text-[10px] px-1">vs</span>
                    ...
                    <div className="p-2.5 rounded-xl bg-[#14100b] border border-stone-800 space-y-1.5">
                      <div className="flex items-center justify-between text-[10px] text-stone-400">
                        <span className="font-mono text-amber-300 font-semibold">COURT 2</span>
                        <span className="font-mono text-amber-200 font-bold">19 - 21</span>
                      </div>
                      <div className="flex items-center justify-between text-[11px] text-stone-200">
                        <span className="truncate">David L. &amp; Jessica</span>
                        <span className="text-stone-500 text-[10px] px-1">vs</span>
                        <span className="truncate">Carlos M. &amp; Aria P.</span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2 py-1">
                    ...
                    <div className="grid grid-cols-3 gap-1 text-center mb-1">
                      <div className="p-1.5 rounded-xl bg-stone-900 border border-stone-800">
                        ...
                        <div className="text-[9px] font-mono text-amber-300 font-bold">39 pts</div>
                      </div>
                      <div className="p-1.5 rounded-xl bg-amber-500/15 border border-amber-500/30">
                        ...
                        <div className="text-[9px] font-mono text-amber-200 font-bold">42 pts</div>
                      </div>
                      <div className="p-1.5 rounded-xl bg-stone-900 border border-stone-800">
                        <span className="text-xs">🥉</span>
                        <div className="text-[10px] font-medium text-stone-200 truncate mt-0.5">
                        ...
                        <div className="text-[9px] font-mono text-amber-300 font-bold">36 pts</div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      {[
                        ...
                        >
                          <span className="font-mono text-stone-400">{r.rank}. {r.name}</span>
                          <div className="flex items-center gap-2 font-mono">
                            <span className="text-amber-200 font-bold">{r.pts} pts</span>
            ...
            {kickserveData.galleryTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-medium transition-colors cursor-pointer ${
                    isActive
                      ? "bg-amber-500/20 text-amber-200 border border-amber-500/50 shadow-xs"
                      : "bg-[#14100b] text-stone-400 border border-stone-800 hover:text-stone-200"
                  }`}
                >
