...
export function HowEnvienStudioWorksSection({
  ...
  return (
    <section
      ...
      className={`scroll-mt-20 relative bg-[#fafaf9] py-8 sm:py-14 lg:py-16 ${className}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        {/* Section Header */}
        <SectionHeader title={title} />

        {/* 2-Column on Mobile (2x2 grid), 4-Column on Desktop */}
        <div className="mt-6 sm:mt-10 lg:mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-6 xl:gap-8">
          {items.map((item) => (
