        ...
        {links.map((item) => {
          ...
          return (
            <Link
              ...
              className="flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-stone-200/80 bg-white hover:bg-stone-100 hover:border-stone-300 text-stone-600 hover:text-stone-950 transition-all duration-200 shadow-2xs active:scale-95 group/social"
            >
              <Icon className="w-4 h-4 transition-transform duration-200 group-hover/social:scale-105" />
            </Link>
          );
        })}
      </div>
