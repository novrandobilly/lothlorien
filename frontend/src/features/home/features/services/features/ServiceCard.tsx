...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <div className="group relative rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col justify-start h-full bg-[#f4f4f3] text-stone-950 border border-stone-200/80 transition-all duration-300 hover:border-stone-300 hover:shadow-sm select-none">
      {/* =========================================================
          TOP ROW: TOP-LEFT ICON & TOP-RIGHT NUMBER
         ========================================================= */}
      <div className="flex items-center justify-between w-full">
        <div className="w-10 h-10 rounded-xl bg-white border border-stone-200/80 flex items-center justify-center text-stone-800 group-hover:bg-stone-950 group-hover:text-white transition-all duration-300 shadow-2xs">
      ...
      <div className="mt-5">
        ...
        <div className="mt-2.5 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-white text-stone-600 border border-stone-200/80 font-sans">
